...
- Nếu làm theo cách trên thì website đang kết nối tới tài khoảng db pockethost của em. Nếu Anh/chị muốn chạy trên tài khoản của riêng mình thì hãy tạo tài khoản trên pockethost.io (có tốn phí), sau đó cập nhật lại url trong file .env và cài đặt colection theo mẫu sau:
